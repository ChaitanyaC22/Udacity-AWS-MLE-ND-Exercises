...
# S3 Bucket name and Prefix to write output data to a folder
BUCKET_NAME = 'sagemaker-studio-774397897175-mcs3venir6c'
PREFIX = 'musical-instruments-reviews/output-solution-lambda-musical-instrument-reviews'
